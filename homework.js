"use strict";
//      task 1
let celsium = 40,   // должен быть prompt('Введите температуру в цельсиях:', 40)
    fahrenheit = celsium * 9 / 5 + 32,
    kelvin = celsium + 273.15,
    rankine = celsium * 1.8 + 491.67

console.log(`По Фаренгейту: ${fahrenheit.toFixed(2)} °F \n
По Кельвину: ${kelvin.toFixed(2)} °K \n
По Ранкину: ${rankine.toFixed(2)} °Ra`) // должен быть alert
